...
$(document).ready(function() {
    ...
    var mobileSessions = $('#morris-donut').data('mobile');
    var desktopSessions = $('#morris-donut').data('desktop');
    ...
    Morris.Donut({
      ...
      data: [
        {value: mobileSessions, label: 'Mobile'},
        {value: desktopSessions, label: 'Desktop'},
      ],
